...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (clojure-cheatsheet helm-ag solarized-theme robe yari enh-ruby-mode yaml-mode use-package swiper-helm super-save smooth-scrolling smex smartparens smart-mode-line skewer-mode rainbow-delimiters psci projectile nyan-mode midje-mode markdown-mode magit ido-ubiquitous hy-mode helm-company haskell-mode groovy-mode git-gutter flx-ido ensime diff-hl cyberpunk-theme crux clojure-snippets clj-refactor cider-eval-sexp-fu browse-kill-ring beacon ace-window ac-cider))))
(custom-set-faces
